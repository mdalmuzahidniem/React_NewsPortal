                ...
                <div className="col-sm-12">
                  <div className="d-sm-flex justify-content-between align-items-center">
                    <div className="fs-14 font-weight-600">
                      © 2020 @ <a href="{{url('https://www.bootstrapdash.com/')}}" target="_blank" className="text-white"> BootstrapDash</a>. All rights reserved.
                    </div>
                    <div className="fs-14 font-weight-600">
                      Handcrafted by <a href="{{url('https://www.bootstrapdash.com/')}}" target="_blank" className="text-white">BootstrapDash</a>
                    </div>
                  </div>
                </div>
              </div>
